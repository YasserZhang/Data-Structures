...
export class LSP {
    ...
    references: {[key:string]:Array<any>}; //list of directly connected routers, format => id: [network, cost, resumed_times]
    ...
    constructor(id: string, network_name: string, sequence_number: number, information: {[key:string]:Array<any>}){
        ...
        this.references = information; // id: [network, cost, resumed_times]
    }
    //cout down by 1
    decrement_ttl() {
        this.time_to_live -= 1;
